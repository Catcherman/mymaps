...
ALTER TABLE `oamp_user_role` ADD CONSTRAINT `FK_user` FOREIGN KEY (`id`) REFERENCES `oamp_user` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `oamp_user_role` ADD CONSTRAINT `FK_role` FOREIGN KEY (`role_id`) REFERENCES `oamp_role` (`role_id`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
INSERT INTO oamp_permission VALUES (4,2,'View Request','/QianYuSrv/oamp/viewData','查看请求','2011-07-05 10:21:00',1);
INSERT INTO oamp_permission VALUES (5,2,'Grammar Upload','/QianYuSrv/oamp/syntaxFileUpload','语法上传','2011-07-05 10:21:00',2);
INSERT INTO oamp_permission VALUES (6,1,'Data Backup','','数据备份','2011-07-06 10:21:00',1);
INSERT INTO oamp_permission VALUES (7,6,'Backup','/QianYuSrv/oamp/backup','数据库备份','2011-07-07 10:21:00',1);
INSERT INTO oamp_permission VALUES (8,6,'Download','/QianYuSrv/oamp/downloadDB','下载备份','2011-07-08 10:21:00',1);
...
INSERT INTO oamp_permission VALUES (15,9,'SQL Query','/QianYuSrv/oamp/sqlQuery','SQL查询','2011-07-14 10:21:00',1);
...
INSERT INTO oamp_permission VALUES (22,16,'Run Status','/QianYuSrv/oamp/machineInfo?type=run','运行状态','2011-07-21 10:21:00',2);
INSERT INTO oamp_permission VALUES (23,16,'Audio Test','/QianYuSrv/oamp/audioTest','音频测试','2011-07-22 10:21:00',1);
...
INSERT INTO oamp_permission VALUES (26,24,'server Debug log','/QianYuSrv/oamp/debugLog?op=serverDebugLog','服务端日志','2011-07-25 10:21:00',1);
...
insert into oamp_permission values (60,16, 'Thread Monitor', '/QianYuSrv/oamp/huagai/thread_monitor', '服务器语音识别线程统计', '2012-12-06 14:33:32', 1);
...
INSERT INTO oamp_role_permission VALUES(null,4,1);
INSERT INTO oamp_role_permission VALUES(null,5,1);
INSERT INTO oamp_role_permission VALUES(null,6,1);
INSERT INTO oamp_role_permission VALUES(null,7,1);
INSERT INTO oamp_role_permission VALUES(null,8,1);
...
INSERT INTO oamp_role_permission VALUES(null,15,1);
...
INSERT INTO oamp_role_permission VALUES(null,22,1);
INSERT INTO oamp_role_permission VALUES(null,23,1);
INSERT INTO oamp_role_permission VALUES(null,24,1);
INSERT INTO oamp_role_permission VALUES(null,25,1);
INSERT INTO oamp_role_permission VALUES(null,26,1);
...
#INSERT INTO oamp_role_permission VALUES(null,6,2);
#INSERT INTO oamp_role_permission VALUES(null,7,2);
#INSERT INTO oamp_role_permission VALUES(null,8,2);
...
#INSERT INTO oamp_role_permission VALUES(null,27,2);
#INSERT INTO oamp_role_permission VALUES(null,28,2);
#INSERT INTO oamp_role_permission VALUES(null,29,2);
INSERT INTO oamp_role_permission VALUES(null,31,1);
INSERT INTO oamp_role_permission VALUES(null,31,2);
